...
#geral #conteudo #text_conteudo table tr td #Accordion1 .AccordionPanel.AccordionPanelOpen .AccordionPanelTab {
	color: #FFF;
	font-size: 16px;
}
-->
  ...
  <div id="text_conteudo">
      <div id="Accordion1" class="Accordion">
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">&Aacute;gua</div>
        ...
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Energia</div>
          <div class="AccordionPanelContent">
            <div id="box">
            <br> 
            <p align="justify">
        ...
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Reciclagem</div>
          <div class="AccordionPanelContent">
             <div id="box">
              <br> 
               <p align="justify">
        ...
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Meio Ambiente</div>
          <div class="AccordionPanelContent">
           <div id="box">
              <br> 
               <p align="justify">
...
Portanto, é essencial que preservemos a nossa casa para que exista meios de prosseguirmos com a vida dos seres vivos na Terra.
  ...
  <div id="text_imagem">
  <img src="imagem/imagem_planeta.jpg" />
  </div>
   </div>
  <div id="rodape">
